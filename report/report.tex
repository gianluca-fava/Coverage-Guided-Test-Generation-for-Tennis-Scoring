...
size~\cite{vargha2000critique,arcuri2014hitchhiker}. We report $A_{12}$ with the
conventional thresholds negligible ($|A_{12}-0.5|<0.056$), small ($<0.14$),
medium ($<0.21$) and large otherwise. $A_{12}>0.5$ favours \texttt{search};
$A_{12}<0.5$ favours the comparison baseline.
